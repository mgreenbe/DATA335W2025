...
(function($){
  $.fn.extend({
    ...
    socialShare: function(options) {
      ...
      var beforeDivs = '<div class="arthref arthrefSocialShare"><div class="overlay '+options.animation+'"><div class="social-container"><div class="centered"><ul>';
      ...
      function createContainer(){
        ...
        'twitter': { text: 'Twitter', className: 'aTwitter', url: 'http://twitter.com/intent/tweet?text={t}%20{u}' },
        ...
        for (var i = 0; i <= sites.length-1; i++) {
          var str_title = options.title;

          // In the case of Twitter, add our site handle to the end of the tweet.
          if ( sites[i] == 'twitter' && typeof window.site_twitter_handle !== 'undefined' ) {
            str_title = str_title + ' @' + window.site_twitter_handle;
          }

          siteSettings[ sites[i] ]['url'] = siteSettings[ sites[i] ]['url'].replace('{t}',encodeURIComponent(str_title)).replace('{u}',encodeURI(options.shareUrl)).replace('{d}',encodeURIComponent(options.description));
